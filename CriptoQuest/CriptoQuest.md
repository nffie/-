...
Подключён смарт-контракт REUSBT в сети Sepolia с использованием предоставленного ABI.
Выполнена попытка вызова функции `mint()` для выпуска SoulBound-токена.
Транзакция отклонена логикой контракта из-за отсутствия прав на выпуск.
